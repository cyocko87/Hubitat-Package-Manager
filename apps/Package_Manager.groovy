...
definition(
	...
	documentationLink: "https://github.com/cyocko87/Hubitat-Package-Manager",
	communityLink: "https://github.com/cyocko87/Hubitat-Package-Manager",
	iconUrl: "",
	iconX2Url: "",
	iconX3Url: "",
	singleInstance: true)
...
def newVersionAvailable(item, installedItem, beta) {
	def result = [newVersion: false, forceProduction: false]
	def versionStr = beta && item.betaVersion != null ? item?.betaVersion : item?.version
